...
class App(Tk):
    ...
    def __init__(self):
        ...
        inner_pannel_drop_huijing = ttk.Button(self.inner_pannel_drop, text="Embers", width=7)
        ...
        inner_pannel_drop_yingguang = ttk.Button(self.inner_pannel_drop, text="Memory", width=7)
