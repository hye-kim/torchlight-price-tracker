...
This guide explains how to create a Windows executable (.exe) file for the Torchlight Infinite Price Tracker.
...
The executable will be created at: `dist\TorchlightInfiniteTracker.exe`
...
- This tool is Windows-only due to dependencies on Windows-specific modules (win32api, win32con, etc.)
- The executable is platform-specific and only works on Windows
